...
| `TESTING_DEBUGGING` | 2.5 | 2.5 | medium | updated_by_evaluation | Evaluation 003: executed and debugged the pipeline, handled a pandas-version date-parsing issue, and verified reconciliation and revenue invariants. | Needs isolated functions, automated tests for exact outputs and edge cases, cleaner failure messages, and regression-style reruns. |
